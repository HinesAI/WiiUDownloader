...
func NewInitialSetupAssistantWindow(config *Config) (*InitialSetupAssistantWindow, error) {
	...
	assistant.SetTitle(appDisplayName + " - Initial Setup")
	...
	page1Label.SetMarkup("<span font='18' weight='bold'>Welcome to " + escapeMarkup(appDisplayName) + "</span>")
	...
	page4SubLabel.SetMarkup("<span font='11' alpha='80%'>" + escapeMarkup(appDisplayName) + " is now configured and ready to use. You can start downloading games immediately or adjust settings in the preferences menu.</span>")
