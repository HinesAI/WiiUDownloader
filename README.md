...
<h1 align="center">WiiUDownloader Forked by HinesAI</h1>

<p align="center">
  <strong>HinesAI fork version 1.1, based on WiiUDownloader 2.99 by Xpl0itU.</strong><br>
...
This is **WiiUDownloader Forked by HinesAI**, version **1.1**.

- **Maintainer and fork developer:** [HinesAI](https://github.com/HinesAI)
- **Original creator and upstream developer:** [Xpl0itU](https://github.com/Xpl0itU)
- **Based on:** [WiiUDownloader 2.99](https://github.com/Xpl0itU/WiiUDownloader)
- **License:** GNU GPLv3

This fork is independently maintained and is not an official release of the upstream WiiUDownloader project. Original copyright and GPLv3 notices are retained.
...
WiiUDownloader Forked by HinesAI is based on [WiiUDownloader](https://github.com/Xpl0itU/WiiUDownloader) 2.99, created by [Xpl0itU](https://github.com/Xpl0itU). HinesAI maintains and develops this fork while preserving the original project's GPLv3 license and attribution.
